"""Textual front-end for alma-certify, shipped in the same package as the suite.
...
unless the guided interface is actually launched. That separation is why it survives the RPMs being
combined - it was never about which package the files land in.
